...
<html> 
<head> 
    <title>Projects Evaluation_3</title> 
...
<div class="container"> 
    ...
    <div class="form-group"> 
        <ul class="nav nav-tabs">
            ...
            <li class="active"><a href="#">Mid Progress Review</a></li>
    ...
    <?php foreach ($records1 as $value) 
    {
        ...
        echo form_open_multipart('faculty/evaluation3_submit',array('class' => 'form-horizontal'));
        echo "
        <input type='text' name='srn' value='".$value->srn."' style='display:none'>
        <table width='100%' class='table' >
        <tr>
        <td><label>Progress of project work :<br><small>(Max. Marks = 20)</small></label>
        <input class='form-control'type='number' min='0' max='20' name='progress' id='progress".$value->srn."' onchange='sum_marks(this.id,\"$value->srn\")' required></td>
