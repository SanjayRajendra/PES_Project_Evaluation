...
<html> 
<head> 
    <title>Projects Evaluation_2</title> 
...
<div class="container"> 
    ...
    <div class="form-group"> 
        <ul class="nav nav-tabs">
            ...
            <li class="active"><a href="#">Progress Review-1</a></li>
    ...
    <?php foreach ($records1 as $value) 
    {
        ...
        echo form_open_multipart('faculty/evaluation2_submit',array('class' => 'form-horizontal'));
        echo "
        ...
        <tr>
        <td>
        <label>Methodology Adopted :<br><small>(Max. Marks = 10)</small></label>
        <input class='form-control' min='0' max='10'type='number' name='method' id='method".$value->srn."' onchange='sum_marks(this.id,\"$value->srn\")' required></td>
