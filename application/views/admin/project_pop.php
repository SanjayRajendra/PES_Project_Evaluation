      ...
      <div class='modal-body'>
        <table class='table'>
          ...
          <tr>
            ...
            <textarea class='form-control' rows='3' id='comment' name='research_area'></textarea></td>
          </tr>
        </table>
        <div class='modal-footer'>
          <button type='button' class='btn btn-success' onclick=\"success('".$r->id."')\" data-dismiss='modal'>Approve</button>
          <button type='button' class='btn btn-danger' onclick=\"reject('".$r->id."');\" data-dismiss='modal'>Reject</button>
