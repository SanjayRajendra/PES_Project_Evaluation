   ...
   <script>
    	function msg()
       	{ 
        	...
        	xmlhttp.open("POST", "<?php echo base_url();?>"+"admin/send_admin/" + $('#userid').val(), true);
        	xmlhttp.send();
    	}
    </script>
</head> 
...
<div class="container"> 
    <div class="page-header" style="margin: auto;"> 
        <img src="<?php echo base_url()?>images/pes_head.png" class="img-responsive">
        <div class="row">
         	<ul class="nav nav-tabs"> 
        		...
        		<li><a href="<?php echo base_url();?>faculty/faculty_login">Faculty Login</a></li> 
         		<li class="active"><a href="<?php echo base_url();?>admin/admin_login">Admin Login</a></li> 
         	</ul>
         </div>
         <h1><small>Admin</small></h1>
    </div>
	<?php echo form_open_multipart('admin/update_admin',array('class' => 'form-horizontal'));?> 
   	<div class="form-group"> 
        <label for="firstname" class="col-sm-2 control-label">Admin ID :</label> 
        <div class="col-sm-6">
       		<input type="text" class="form-control" id="userid" name="userid" placeholder="Enter Admin ID" required value= <?php echo set_value('userid');?>>
