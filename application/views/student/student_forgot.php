...
<html> 
   <head> 
      ...
      <script src="<?php echo base_url();?>js/student_mail.js"></script>
   </head> 
   <body> 
      <div class="container"> 
         ...
         <?php echo form_open_multipart('student/update_student',array('class' => 'form-horizontal'));?>   
         <div class="form-group"> 
            <label for="firstname" class="col-sm-2 control-label">Student SRN :</label> 
            <div class="col-sm-6">
               <input type="text" class="form-control" id="userid" name="userid" placeholder="Enter ID" required value= <?php echo set_value('userid');?>>
